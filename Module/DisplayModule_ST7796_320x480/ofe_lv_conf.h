// Project-local LVGL configuration for DisplayModule_800x480.
// Keep a 48 KiB hot pool internal; setup adds 144 KiB in PSRAM before building widgets.
// Based on the working lv_conf.h; the small display's configuration is unchanged.
/**
 * @file lv_conf.h
 ...
 * - LV_STDLIB_CUSTOM:      Implement the functions externally
 */
// Use the SDK's optimized memcpy/memset, including unaligned row copies.
...
#define LV_USE_PROFILER 0
    ...
    #define LV_PROFILER_INCLUDE "ofe_lv_profiler.h"

    /** Profiler start point function */
    #define LV_PROFILER_BEGIN    OFE_LV_PROFILE_BEGIN_TAG(__func__)

    /** Profiler end point function */
    #define LV_PROFILER_END      OFE_LV_PROFILE_END_TAG(__func__)

    /** Profiler start point function with custom tag */
    #define LV_PROFILER_BEGIN_TAG OFE_LV_PROFILE_BEGIN_TAG

    /** Profiler end point function with custom tag */
    #define LV_PROFILER_END_TAG   OFE_LV_PROFILE_END_TAG
