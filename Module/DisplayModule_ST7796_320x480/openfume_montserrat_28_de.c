 ...
 * Size: 28 px
 * Bpp: 4
 * Opts: --font /mnt/data/fonttmp/node_modules/@fontsource/montserrat/files/montserrat-latin-500-normal.woff -r 0x20-0x7F,0xA0-0xFF,0x2022,0x00B0 --size 28 --bpp 4 --format lvgl -o /mnt/data/OpenFume_Display_Montserrat_Medium_DE/DisplayModule/openfume_montserrat_28_de.c --lv-font-name openfume_montserrat_28_de --no-compress --lv-fallback lv_font_montserrat_14
 ******************************************************************************/

// Generated LVGL bitmap font from Montserrat Medium (500), size 28, bpp 4.
// Character range: ASCII + Latin-1 (ÄÖÜäöüß etc.) + ° + bullet.
// Keep this file in the same Arduino sketch folder as DisplayModule.ino.


#include <lvgl.h>

#ifndef OPENFUME_MONTSERRAT_28_DE
#define OPENFUME_MONTSERRAT_28_DE 1
#endif

#if OPENFUME_MONTSERRAT_28_DE
...
static const lv_font_fmt_txt_cmap_t cmaps[] =
{
    ...
    {
        .range_start = 8226, .range_length = 1, .glyph_id_start = 191,
        .unicode_list = NULL, .glyph_id_ofs_list = NULL, .list_length = 0, .type = LV_FONT_FMT_TXT_CMAP_FORMAT0_TINY
    }
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t openfume_montserrat_28_de = {
#else
lv_font_t openfume_montserrat_28_de = {
#endif
...
#endif /*#if OPENFUME_MONTSERRAT_28_DE*/
